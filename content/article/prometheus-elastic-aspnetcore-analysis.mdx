...
- Backup storage: €480/year (~300GB backup data)
...
- Backup storage: €240/year (~75GB backup data)

Operational:
- Maintenance (1.5h/week × €95/h): €7,410/year
- Upgrades and patches: €800/year
- Dashboard development (minimal): €800/year

Total Annual Cost: €12,628
3-Year Total: €37,884
```

**On-Premise Savings: €8,736 over 3 years (19% cost reduction)**
...
- OS licenses: €0/year (Linux)
- Backup storage: €240/year (~75GB backup data)
- Operational costs: €9,010/year
3-Year Total: €36,174

Linux Savings: €11,616 over 3 years (24% cost reduction)
```

**Key Insight**: The primary cost driver is **resource usage** (RAM/CPU), not licensing. Linux eliminates the licensing component entirely.
...
2. **Cost Savings**: €8,736 savings over 3 years (19% reduction on Windows, 24% on Linux)
...
- **19-24% cost reduction on-premise** (€8,736-11,616 savings depending on OS choice)
