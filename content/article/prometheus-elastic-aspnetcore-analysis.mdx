...
- **Dashboard creation complexity**: When using OpenTelemetry with Elastic APM Server, pre-built dashboards require significant customization because:
  - APM Server transforms OpenTelemetry metrics into Elastic's proprietary format
  - Microsoft's ASP.NET Core dashboards expect native OpenTelemetry format (as preserved by Prometheus)
  - Each monitoring backend requires different dashboard templates due to format differences
  - *([Detailed technical explanation](./opentelemetry-architecture-dashboard-compatibility))*
- Limited integration with ASP.NET Core's native metrics when using Elastic APM Agent
...
- VM costs (12GB RAM, 8 vCPU): €4,320/year
- Storage (500GB): €720/year
- Windows Server licenses: €1,440/year
- Backup solutions: €480/year

Operational:
- Maintenance (3h/week × €95/h): €14,820/year
- Upgrades and patches: €2,400/year
- Dashboard development: €4,800/year
...
```
Infrastructure (Windows VMs):
- VM costs (7GB RAM, 5 vCPU): €2,520/year
- Storage (200GB): €288/year
- Windows Server licenses: €960/year
- Backup solutions: €240/year

Operational:
- Maintenance (1h/week × €95/h): €4,940/year
- Dashboard development savings: -€3,600/year
- Reduced complexity: -€1,200/year

Total Annual Cost: €4,148
3-Year Total: €12,444
```

**On-Premise Savings: €74,496 over 3 years (86% cost reduction)**
...
Integration overhead: €2,400/year
Data transfer costs: €720/year
Management overhead: €3,600/year
...
```
Service Costs: €5,040/year (high estimate)
Native integration benefits: -€1,800/year
Reduced operational overhead: -€3,000/year
Dashboard development savings: -€3,600/year

3-Year Total: -€10,080 (net savings)
```

**Cloud Environment Savings: €56,160 over 3 years**
...
2. **Cost Savings**: €74,496 savings over 3 years (86% reduction)
3. **Maintenance Reduction**: 1 hour/week vs 3 hours/week
4. **Windows Compatibility**: Runs natively on current Windows infrastructure
5. **Ready-Made Dashboards**: Microsoft's ASP.NET Core dashboards save 20-40 development hours
...
- **86% cost reduction on-premise** (€74,496 savings)
